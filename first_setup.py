"""
В данном модуле написана подпрограмма первичной настройки Funpay'а.
"""
...
def first_setup():
    ...
    while True:
        ...
        if not password:
            print(
                f"\n{Fore.CYAN}{Style.BRIGHT}Пароль не может быть пустым. Попробуй еще раз! {Fore.RED}\(!!˚0˚)/{Style.RESET_ALL}")
            continue
        break
